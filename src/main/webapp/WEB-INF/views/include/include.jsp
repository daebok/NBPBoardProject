...
<link type="text/css" rel="stylesheet" 				href="<c:url value="/resources/summernote/summernote.css" />" >
<link type="text/css" rel="stylesheet" 				href="<c:url value="/resources/common/css/loading.css" />" >
