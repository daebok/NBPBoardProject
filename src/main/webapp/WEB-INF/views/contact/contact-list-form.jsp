		...
		<div class="list-group-item">
			<div  class="list-1">
				<c:choose>
					...
					<c:otherwise>
						<a class="contact-title" href="${path}/contact/view${pageMaker.makeQuery(pageMaker.cri.page)}&contactNo=${contact.contactNo}"><c:out value="${contact.contactTitle}" escapeXml="false"></c:out></a>
					</c:otherwise>
				</c:choose>
